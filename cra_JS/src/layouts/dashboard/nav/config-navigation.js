...
// Persius added and structured documents path
  ...
  // ----------------------------------------------------------------------
  {
    ...
    items: [
      { title: 'Service Booking', path: PATH_DASHBOARD.general.booking, icon: ICONS.booking },
      { title: 'website', path: PATH_DASHBOARD.blog.root, icon: ICONS.blog},
      { title: 'Team',path: PATH_DASHBOARD.user.cards,icon: ICONS.user },
      { title: 'Calendar', path: PATH_DASHBOARD.calendar, icon:ICONS.calendar },
      { title: 'Tasks', path: PATH_DASHBOARD.kanban, icon:ICONS.kanban },
      { title: 'Documents', path: PATH_DASHBOARD.general.file,icon: ICONS.file },
      { title: 'File manager', path: PATH_DASHBOARD.fileManager,icon: ICONS.folder },
